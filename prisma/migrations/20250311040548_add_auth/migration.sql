/*
  ...
  - You are about to drop the column `accountId` on the `Workspace` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Workspace" DROP CONSTRAINT "Workspace_accountId_fkey";
...
-- AlterTable
ALTER TABLE "Workspace" DROP COLUMN "accountId",
ADD COLUMN     "organizationId" INTEGER;

-- AlterTable
ALTER TABLE "_TaskToUser" ALTER COLUMN "B" SET DATA TYPE TEXT;
